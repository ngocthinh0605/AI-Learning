...
const SKILLS = [
  ...
  },
  {
    ...
    label:    "Listening",
    Icon:     Headphones,
    desc:     "Audio passages with comprehension tasks. Coming soon.",
    path:     null,
    active:   false,
    color:    "text-gray-500",
    bg:       "bg-gray-800/30",
  ...
  },
  {
    ...
    label:    "Writing",
    Icon:     PenLine,
    desc:     "Task 1 & Task 2 essay practice with AI feedback. Coming soon.",
    path:     null,
    active:   false,
    color:    "text-gray-500",
    bg:       "bg-gray-800/30",
  ...
  },
  {
    ...
    label:    "Speaking",
    Icon:     Mic2,
    desc:     "Part 1, 2 & 3 speaking practice with AI evaluation. Coming soon.",
    path:     null,
    active:   false,
    color:    "text-gray-500",
    bg:       "bg-gray-800/30",
